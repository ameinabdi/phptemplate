...
class tDAL
{
	var $tblemis_at_localhost_dbo_user;
	var $tblemis_at_localhost_INFORMATION_SCHEMA_CHECK_CONSTRAINTS;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "user", "varname" => "emis_at_localhost_dbo_user", "altvarname" => "user", "connId" => "emis_at_localhost", "schema" => "dbo", "connName" => "emis at localhost");
		$this->lstTables[] = array("name" => "CHECK_CONSTRAINTS", "varname" => "emis_at_localhost_INFORMATION_SCHEMA_CHECK_CONSTRAINTS", "altvarname" => "CHECK_CONSTRAINTS", "connId" => "emis_at_localhost", "schema" => "INFORMATION_SCHEMA", "connName" => "emis at localhost");
	}
