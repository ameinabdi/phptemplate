...
require_once("include/check_constraints_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "INFORMATION_SCHEMA.CHECK_CONSTRAINTS" );
