...
class ConnectionManager
{
	...
	{
		return $this->byId( "emis_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 2;
		$data["connId"] = "emis_at_localhost";
		$data["connName"] = "emis at localhost";
		$data["connStringType"] = "mssql";
		$data["connectionString"] = "mssql;localhost;sa;123;emis"; //currently unused

		$this->_connectionsIdByName["emis at localhost"] = "emis_at_localhost";
		...
		$data["connInfo"][1] = "sa";
		$data["connInfo"][2] = "123";
		$data["connInfo"][3] = "emis";
		$data["connInfo"][4] = "";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = ""; //currently unused
		$data["ODBCString"] = "Provider=SQLOLEDB;Server=localhost;Uid=sa;Pwd=123;Database=emis";
		// encription set
		...
		$connectionsData["emis_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["INFORMATION_SCHEMA.CHECK_CONSTRAINTS"] = "emis_at_localhost";
		$connectionsIds["dbo.user"] = "emis_at_localhost";
