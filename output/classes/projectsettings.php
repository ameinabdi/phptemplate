...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "INFORMATION_SCHEMA.CHECK_CONSTRAINTS" ] = array( "url" => "check_constraints", "type" => 0 );
	$projectEntitiesReverse[ "check_constraints" ] = "INFORMATION_SCHEMA.CHECK_CONSTRAINTS";
	$projectEntities[ "dbo.user" ] = array( "url" => "user", "type" => 0 );
	$projectEntitiesReverse[ "user" ] = "dbo.user";
}
