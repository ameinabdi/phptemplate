...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "emis_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "user", "varname" => "emis_at_localhost_dbo_user", "altvarname" => "user", "connId" => "emis_at_localhost", "schema" => "dbo", "connName" => "emis at localhost");
			$dalTables[$conn->connId][] = array("name" => "CHECK_CONSTRAINTS", "varname" => "emis_at_localhost_INFORMATION_SCHEMA_CHECK_CONSTRAINTS", "altvarname" => "CHECK_CONSTRAINTS", "connId" => "emis_at_localhost", "schema" => "INFORMATION_SCHEMA", "connName" => "emis at localhost");
		}
	}
